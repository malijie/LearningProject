...
import com.chinamobile.xiaoyi.receiver.TrackReceiver;
...
import com.chinamobile.xiaoyi.util.ViewUtil;

/**
 * Created by malijie on 2017/9/11.
 */

public class TracingActivity extends AppBaseActivity implements View.OnClickListener {
...
//        setOnClickListener(this);
    ...
    private void init() {
        initListener();
        trackApp = (XiaoYiHelpApplication) getApplicationContext();
