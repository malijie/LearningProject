...
public class ViewPagerIndicator extends LinearLayout {
	...
	private static final int COLOR_TEXT_NORMAL = CommonUtil.getColor(R.color.font_black);
	private static final int COLOR_TEXT_HIGHLIGHT = CommonUtil.getColor(R.color.app_red);
