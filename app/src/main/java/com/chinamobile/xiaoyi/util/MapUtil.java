...
import static com.chinamobile.xiaoyi.util.BitmapUtil.bmEnd;
import static com.chinamobile.xiaoyi.util.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(XiaoYiHelpApplication trackApp) {
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > XiaoYiHelpApplication.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > XiaoYiHelpApplication.screenWidth - 200
                    || null == mapStatus) {
